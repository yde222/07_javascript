...
// Date.parse : 1970년 1월 1일 00:00:00(UTC)을 기점으로 
// 인수로 전달된 지정 시간(new Date(dateString)의 인수와 동일한 형식)까지의 밀리초를 숫자로 반환한다. ### Date.UTC
...
// Date.UTC : 1970년 1월 1일 00:00:00(UTC)을 기점으로 
// 인수로 전달 된 지정 시간까지의 밀리초를 숫자로 반환한다.
...
// Date.prototype.getTimezoneOffset : UTC와 Date 객체에 지정된 로케일 시간가의 차이를 분 단위로 반환한다.
