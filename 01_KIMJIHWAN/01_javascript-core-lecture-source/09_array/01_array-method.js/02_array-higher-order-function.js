...
console.log(numbers);
const odds = numbers.filter(item => item % 2);  // 나머지 1 >>>> true여서 // 짝수에만 쓸거에요
console.log(odds);  // 1, 3, 5

// Array.prototype.reduce : 배열을 순회하며 각 요소에 대하여 이전의 콜백함수 실행 반환값을 전달하여 콜백함수를 실행하고 그 결과를 반환함
...
console.log("result :", result);        // console.log("result :" + result); 와 다르게 인자만
